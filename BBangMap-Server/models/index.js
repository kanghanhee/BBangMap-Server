...
db.MissionWhether = require("../src/mission/model/MissionWhether")(
  sequelize,
  Sequelize
);
...
db.User.belongsToMany(db.Bakery, {
  through: "SaveBakery",
  as: "SavedBakery"
});
db.Bakery.belongsToMany(db.User, {
  through: "SaveBakery",
  as: "SaverBakery"
});
