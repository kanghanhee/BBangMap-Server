...
router.get('/search/bread', authUtil.checkToken, redisMiddleware, bakeryController.bakerySearchByBread);
router.get('/search/review', authUtil.checkToken, bakeryController.bakerySearchReviewByBread);
router.get('/search/area', authUtil.checkToken, redisMiddleware, bakeryController.bakerySearchByArea);
router.get('/detail', authUtil.checkToken, redisMiddleware, bakeryController.bakeryDetail);
