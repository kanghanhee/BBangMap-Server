...
router.get('/storage', authUtil.checkUuid, reviewController.savedReviewFolderList);
router.get('/storage/:bakeryId', authUtil.checkUuid, reviewController.savedReviewOfBakeryList);
router.get('/my', authUtil.checkUuid, reviewController.myReview);

router.post('/my', authUtil.checkUuid, reviewImgUpload, reviewController.addReview);
router.post('/storage/:reviewId', authUtil.checkUuid, reviewController.saveReview);
router.post('/like/:reviewId', authUtil.checkUuid, reviewController.likeReview);

router.delete('/my/:reviewId', authUtil.checkUuid, reviewController.deleteMyReview);
router.delete('/storage/:reviewId', authUtil.checkUuid, reviewController.unSaveReview);
router.delete('/unlike/:reviewId', authUtil.checkUuid, reviewController.unLikeReview);
