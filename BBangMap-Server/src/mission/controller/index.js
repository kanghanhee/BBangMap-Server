    ...
    try {
      ...
      res
        ...
        .send(
          util.success(
            statusCode.OK,
            responseMessage.SUCCESS_CREATE_MISSION,
            result
          )
        );
    } catch (err) {
    ...
    try {
      ...
      res
        ...
        .send(
          util.success(
            statusCode.OK,
            responseMessage.SUCCESS_GET_MONTHLY_MISSION,
            result
          )
        );
    } catch (err) {
    ...
    try {
      ...
      res
        ...
        .send(
          util.success(
            statusCode.OK,
            responseMessage.SUCCESS_GET_SUCCEEDED_MISSION,
            result
          )
        );
    } catch (err) {
    ...
    try {
      ...
      res
        ...
        .send(
          util.success(
            statusCode.OK,
            responseMessage.SUCCESS_GET_USER_RANK,
            result
          )
        );
    } catch (err) {
